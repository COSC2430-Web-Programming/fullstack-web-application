                ...
                <div class="row justify-content-center">
                    <div class="col-sm-8 col-10 d-flex justify-content-center">
                        <div class="card col-sm-8">
                            ...
                            <img src='<?php echo "../../../assets/images/".$detail['image'] ?>' class="img-fluid w-100"
                                alt="product_img" id='productImg'>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between mt-4 mb-4 align-items-center w-100">
                                    ...
                                    <p id='productPrice' class="mb-4 d-flex justify-content-end fw-bold fs-3">
                                        <?= $detail['price'] ?></p>
                                </div>
                                <p id='productDescription' class="card-text mb-5 text-wrap text-justify">
