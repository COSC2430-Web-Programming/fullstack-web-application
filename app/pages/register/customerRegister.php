...
<?php
   if(isset($_POST['submit'])){
      ...
      $user = new Customer($username, $password, $imageNameNew, $name, $address);
   }
?>
        ...
        <div class='row justify-content-center'>
            ...
            <div class="col-10">
                <ul class='d-flex justify-content-around list-unstyled text-center'>
                    ...
                    <li class=' col-lg-2 col-md m-2 p-2 bg-secondary border border-secondary '><span class=' text-white' id="userRole">Customer</span></li>
